...
myplot <- function(data, player=1:10) {
  matplot(t(data[player,,drop=F]), type="b", pch=15:18, col=c(1:4,6), main="Basketball Players Analysis")
  legend("bottomleft", inset=0, legend=Players[player], col=c(1:4,6), pch=15:18, horiz=F)
}
